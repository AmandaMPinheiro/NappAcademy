...
departamento = Departamento('Departamento XYZ', 'Amanda', hoje.day, hoje.month, 2021)
...
for aniversariante in aniversariantes:
    print(f'Parabéns {aniversariante[0]}, do {aniversariante[3]}, pelo seu dia! O responsável pelo departamento é {aniversariante[2]}.')
