...
class TestDepartamento:
    ...
    def test_setters(self):
        objeto = Departamento('Curadoria', 'Matheus', 14, 2, 2020)
    ...
    def test_verificar_aniversariantes(self):
        retorno = [('João Oliveira', '1992-05-17', 'José da Silva', 'Departamento XYZ '), 
                   ('Luis Fernando', '2000-05-17', 'José da Silva', 'Departamento XYZ ')]
